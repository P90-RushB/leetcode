############################## 看这个就够了 #################################
# 想真正理解遍历（至少前序和中序），就要明白递归的路径，那也就是要明白怎么用迭代（手动栈）来遍历，
# 而能快速理解迭代遍历二叉树的方法，看这道题：173. 二叉搜索树迭代器， 这题看懂就会写了，简直太有助于理解了。
# 这题是用迭代遍历，并且可以控制运行流程，看了之后就理解了一路压栈操作，弹出操作，添加右节点操作之间的关系了。
